					...
					<div className='filter-container'>
						...
						<div className='avail'>
							...
							<div className='category'>
								{this.props.outStock ? (
									<i class='fas fa-check-square' onClick={this.props.handleProductInStock}></i>
								) : (
									<div className='uncheck' onClick={this.props.handleProductOutStock}></div>
								)}
								<p>Out of Stock</p>
							</div>
						</div>
									...
									return (
										<div key={index} onClick={() => this.props.handleColorFilter(color)}>
											<div className='colorCheck'>
												{color.toLowerCase() === this.props.presentColor.toLowerCase() ? (
						...
						{this.props.category && this.props.category.subcategories ? (
							<div className='cat'>
								...
								{this.props.category.subcategories.map((sub, index) => {
									return (
										<a key={index} href={"/Category/" + this.props.category.name + "/" + sub.name}>
											<div className='category'>
												{sub.name.toLowerCase() === this.props.subCat.toLowerCase() ? (
													<i className='fas fa-check-square'></i>
												) : (
													<div className='uncheck'></div>
												)}
