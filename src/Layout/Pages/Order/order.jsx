				...
				this.setState(
					...
					async () => {
						...
						if (this.state.order.tracking) {
							var res = await axios.post("http://localhost:5000/api/trackOrder", data);
										...
										<div className='section_content'>
											<div className='status'>
												...
												<div className='icon_text'>
													...
													<p>Come back to this page for updates on your shipment status.</p>
												</div>
											</div>
											<div className='order_update'>
												...
												<div className='order-status'>
													{this.state.shipmentActivities.length > 0 ? (
														...
														<p className='noUpdates'>Currently there are no updates available ...</p>
													)}
												</div>
											</div>
											<div className='message'>
												<p>
													Thank You For Placing Your Order. You will Receive an SMS on your registered mobile number with a link asking you to confirm your COD Order. Kindly
										...
										<div className='modal-body'>
											{this.state.rateProducts.map((product, index) => {
												if (index === this.state.reviewProductCount && !product.rate) {
													return (
														<>
															<OrderCard item={this.state.rateProducts[this.state.reviewProductCount]} key={index} />
								...
								<div className='rating-modal'>
									...
									<div className='modal-body'>
										<div className='dropdown'>
											<select onChange={(e) => this.setState({ replacementReason: e.target.value })}>
