														...
														<div
															...
															onClick={() =>
																(window.location.href =
																	"/Checkout/" + this.state.product.id + "/" + this.state.usersQuantity)
															}>
										...
										<div className='description-section'>
											...
											<div className='price'>
												...
												<div className='product-discount'>
													{100 - Math.round((this.state.product.sp / this.state.product.cp) * 100)}% off
											</div>
											</div>
													...
													<>
														<div className='quantity-cont'>
															...
															<div className='quantity'>
																...
																{
																	this.state.usersQuantity === parseInt(this.state.product.max)
																		?
																		<span className='symbol grey'>
																			+
															</span>
							...
							{this.state.simProducts.length > 0 ? (
								<>
									<div className='product-like'>
										<Slider data={this.state.simProducts} title={this.state.sliderTitle} view={false} />
									</div>
										...
										{this.state.product.quantity > 0 ? (
											<>
												...
												<div
													className='option'
													onClick={() =>
														(window.location.href = "/Checkout/" + this.state.product.id + "/" + this.state.usersQuantity)
													}>
													<i className='fas fa-bolt'></i>
													<p>BUY NOW</p>
												</div>
