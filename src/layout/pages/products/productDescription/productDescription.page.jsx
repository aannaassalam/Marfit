  ...
  render() {
    const marks = {
      ...
      10: (
        <div className="sliderLabel">
          <div className="indicator"></div>
          {this.state.value !== 10 ? <p>10</p> : <p className="active">10</p>}
        </div>
      ),
    };
                      ...
                      <div className="price-amt">
                        <div className="month-price">
                          ...
                          <ReactTooltip id="month-info" effect="solid">
                            <p className="tool-tip-info">Sale Price</p>
                          </ReactTooltip>
                        </div>
                        <div className="deposit-price">
                          ...
                          <ReactTooltip id="deposit-info" effect="solid">
                            <p className="tool-tip-info">Actual Price</p>
                          </ReactTooltip>
                        </div>
                      </div>
